	...
	*/
	...
	$('.top-menu').on('click', 'a', function(){
		...
		var id = $(this).attr('href');
		 if(id == '#contacts-card' || id == '#resume-card' || id == '#about-card'  ){
		...
		if((width < 1024)) {
			...
			$(window).on('scroll', function(){
				...
				$('.top-menu ul li a').each(function () {
					var currLink = $(this); 
					if (currLink[0].hash == "#about-card" || currLink[0].hash == "#resume-card" || currLink[0].hash == "#works-card" || currLink[0].hash == "#contacts-card") {
